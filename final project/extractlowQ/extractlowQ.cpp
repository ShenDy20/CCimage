...
int main()
{
	...
	for (int j = 0; j < 50; j++)
	{
		string labelfile = "./label2/" + to_string(j) + ".txt";
	...
	for (int j = 0; j < 50; j++)
	{
		string file1 = "./2d/C" + to_string(j) + ".txt";
		ifstream in(file1);
		string line;
...
unsigned seed = std::chrono::system_clock::now().time_since_epoch().count();
		for (int I = 0; I < 5; I++)
		{
			...
			string testfile = "./test2d/" + to_string(cnt2) + ".txt";
		...
		for (int I = 0; I < 50; I++)
		{
			...
			string trainfile = "./train2d/" + to_string(cnt1) + ".txt";
	...
	fprintf(fp2, "\n");
		...
		*/
		string trainl = "./train2d/train.txt";
		FILE* fp1;
