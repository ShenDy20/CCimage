...
train_dataset = ImageFolder("./generator/train/",transform = train_transform) #训练集数据
...
test_dataset = ImageFolder("./generator/test/",transform = test_transform) #测试集数据
test_loader = torch.utils.data.DataLoader(dataset=test_dataset, batch_size=BATCH_SIZE, shuffle=False,num_workers=0) #加载数据
